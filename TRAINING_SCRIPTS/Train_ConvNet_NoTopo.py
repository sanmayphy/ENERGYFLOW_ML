...
# %%
file_path = '/storage/agrp/sanmay/PFLOW_ANALYSIS/RectangularGeo/CROSS_CHECK/Outputfile_NoTopo_'+nameSourceFile+'.hdf5'
...
for epoch in range(1, n_epochs+1):
    ...
    if valid_loss <= valid_loss_min:
        ...
        valid_loss_min,
        valid_loss))
        torch.save(model.state_dict(), 'model_ConvNet_NoTopo_' + nameSourceFile + '.pt')
