...
model.load_state_dict(torch.load('./model_ConvNet_NoTopo_'+nameSourceFile+'.pt'))
model.eval()
...
hf = h5py.File('TOPO_FILES/PredictionFile_ConvNet_NoTopo_' + nameSourceFile + '_V1.h5', 'w')
