...
test_data_topo = f['test']['topocluster'][:ntrain]
...
hf = h5py.File('TOPO_FILES/PredictionFile_Graph_' + nameSourceFile + '_V1.h5', 'w')
...
hf.create_dataset('Topocluster', data=test_data_topo)
